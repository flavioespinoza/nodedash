...
function api_market_info(market) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let _url = utils._url_interval(market.pairing, market.interval);
            let get_candles = yield axios.get(_url);
...
function gather_ignore_list(ignore_list_symbols) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let _q = _query_ignore_list(ignore_list_symbols);
            let _get_ignore_list = yield es_ignore_list(_q);
...
function gather_watchlist(watchlist_symbols) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let _q = _query_watchlist(watchlist_symbols);
            let _get_watchlist = yield es_watchlist(_q);
...
// SIMPLE LIST DATA
function get_simple_data(prefs, _q) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Gather Data
            let _url = utils._es_url(_index, _q);
...
function io_simple_data(_q, socket, prefs) {
    (function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let simple_data = yield get_simple_data(prefs, _q);
                if (!simple_data) {
                    return;
                }
...
// COMPOUND LIST DATA
function get_compound_data(prefs) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let get_items = yield utils._calculate_vol(prefs);
            let get_obo = yield utils._calculate_obo(prefs);
            let get_trades = yield utils._calculate_trades_history(prefs);
            let items_compound = [];
            _.each(get_items, function (obj) {
                ...
                let res = Object.assign({}, obj, obo, trades);
...
function io_compound_data(socket, prefs) {
    (function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let compound_data = yield get_compound_data(prefs);
                if (!compound_data) {
                    return;
                }
...
// UNIVERSAL DATA
function get_all_simple_data(prefs) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Gather Dat
            ...
            const all_markets = yield _all_markets();
            // Result
            return {
    ...
    (function () {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let all_simple_data = yield get_all_simple_data(prefs);
                if (!all_simple_data) {
                    return;
                }
...
const SocketEvents = (io) => {
    io.on('connection', (socket) => {
        ...
        socket.on('authenticated_user', (data) => {
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    let get_prefs = yield utils._get_user_prefs(data.auth_user, user_prefs_default, null);
        ...
        socket.on('vol_multiplier', (data) => {
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (data.auth_user.path_name === '/compound_list') {
                        io_compound_data(socket, prefs);
                        yield utils._set_user_prefs(data.auth_user, prefs);
                    }
                });
            })();
        });
        ...
        socket.on('interval', (data) => {
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    let update = yield utils._update_user_pref(data);
                    io_simple_data(update._q, socket, update.prefs);
                    yield utils._set_user_prefs(data.auth_user, update.prefs);
                });
            })();
        });
        socket.on('set_percent_up', (data) => {
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    let update = yield utils._update_user_pref_percent_props(data);
                    io_simple_data(update._q, socket, update.prefs);
                    yield utils._set_user_prefs(data.auth_user, update.prefs);
                });
            })();
        ...
        socket.on('show_percent_props', (data) => {
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    data.side = 'show';
                    let update = yield utils._update_user_pref_percent_props_show(data);
                    io_simple_data(update._q, socket, update.prefs);
                    yield utils._set_user_prefs(data.auth_user, update.prefs);
        ...
        socket.on('filter_by_quote', (data) => {
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    let update = yield utils._update_user_pref_quote(data);
                    io_simple_data(update._q, socket, update.prefs);
                    yield utils._set_user_prefs(data.auth_user, update.prefs);
                });
            })();
        ...
        socket.on('set_watchlist_symbols', (data) => {
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    let update = yield utils._update_user_pref_watchlist_symbols(data);
                    yield utils._set_user_prefs(data.auth_user, update.prefs);
                });
            })();
        });
        socket.on('set_ignore_list_symbols', (data) => {
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (data.auth_user.path_name === '/simple_list') {
                        let update = yield utils._update_user_pref_ignore_list_symbols(data);
                        io_simple_data(update._q, socket, update.prefs);
                        yield utils._set_user_prefs(data.auth_user, update.prefs);
                    }
                    else if (data.auth_user.path_name === '/compound_list') {
        ...
        socket.on('get_market_details', (data) => {
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    let candle_data = yield api_market_info(data);
